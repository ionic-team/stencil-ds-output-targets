...
| `outputType`           | The type of output to generate. If `component`, the output target will generate lazy loaded component wrappers tied. If `scam`, the output target will generate a single component angular module for each component. If `standalone`, standalone component wrappers will be generated. |
